...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid kryptoniex address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid kryptoniex address" in e.error['message'])
