...
This document provides guidelines for internationalization of the KRYPTONIEX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kryptoniex_en.ts` remains unchanged.
