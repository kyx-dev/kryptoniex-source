...
This mechanism has been integrated into Bitcore-Node-KRYPTONIEX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/kryptoniexpay/insight-api-kryptoniex#web-socket-api](https://github.com/kryptoniexpay/insight-api-kryptoniex#web-socket-api)
* API: [https://github.com/kryptoniexpay/insight-api-kryptoniex#instantsend-transactions](https://github.com/kryptoniexpay/insight-api-kryptoniex#instantsend-transactions)
...
By default, the KRYPTONIEX Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KRYPTONIEX Core daemon:
