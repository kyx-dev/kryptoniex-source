...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, const std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all KRYPTONIEX related functionality
...
/*
    ...
    allow endless transaction that would bloat KRYPTONIEX and make it unusable. To
...
void ThreadCheckPrivateSendServer(CConnman& connman)
{
    ...
    RenameThread("kryptoniex-ps-server");
