/* src/config/kryptoniex-config.h.  Generated from kryptoniex-config.h.in by configure.  */
/* src/config/kryptoniex-config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The KRYPTONIEX Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "KRYPTONIEX Core"
...
#define PACKAGE_BUGREPORT "https://github.com/kryptoniexpay/kryptoniex/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "KRYPTONIEX Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "KRYPTONIEX Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "kryptoniexcore"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://kryptoniex.org/"
