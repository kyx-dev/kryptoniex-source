...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KRYPTONIEX address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and kryptoniex: URIs)"));
    ...
    aboutAction->setStatusTip(tr("Show information about KRYPTONIEX Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KRYPTONIEX addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KRYPTONIEX addresses"));
    ...
    openAction->setStatusTip(tr("Open a kryptoniex: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible KRYPTONIEX command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KRYPTONIEX network", "", count));
    } else {
...
{
    QString strTitle = tr("KRYPTONIEX Core"); // default title
    ...
    // Append title to "KRYPTONIEX Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
