    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  kryptoniex-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the KRYPTONIEX in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 KYX, 0.1 KYX, 1 KYX and 10 KYX -- sort of like the paper money you use every day.</li> \
