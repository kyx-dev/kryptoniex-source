    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("KYX-light"), QVariant("light"));
    ui->theme->addItem(QString("KYX-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("KYX-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("KYX-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("KYX-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("KYX-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("KYX-traditional"), QVariant("trad"));
