...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print KRYPTONIEX address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "kryptoniex",               "masternode",             &masternode,             true,  {} },
    { "kryptoniex",               "masternodelist",         &masternodelist,         true,  {} },
    { "kryptoniex",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "kryptoniex",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "kryptoniex",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "kryptoniex",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
