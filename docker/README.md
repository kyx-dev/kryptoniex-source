...
official/supported Docker Images found at https://hub.docker.com/r/kryptoniexpay/kryptoniexd/
...
**NOTE: Please update the image description at https://hub.docker.com/r/kryptoniexpay/kryptoniexd-develop/ when changing the above text**